                ...
                <div className="invoice" ref={invoiceRef} >
                    <header className="header px-2 pt-2">
                        ...
                        <div className="recipient">
                            ...
                            <h6>{orderDetails?.shipping_city} {orderDetails?.shipping_country}</h6>
                    ...
                    <section className="company-info px-2">
                        ...
                        <div>
                            <p>Email</p>
                            <h6 className='p-1 w-100' style={{ backgroundColor: "#f2f2f2" }}>{orderDetails?.customer_email}</h6>
                    ...
                    <section className=' px-2'>
                        <div>
                            <div className='d-flex gap-1 w-100'>
                                <div style={{ width: "25%" }}>
                                    <p>Invoice No</p>
                                    <h6 className='p-1 w-100' style={{ backgroundColor: "#f2f2f2" }}>{orderDetails?.number}</h6>
                                </div>
                                <div style={{ width: "25%" }}>
                                    <p>Date</p>
                                    <h6 className='p-1 w-100' style={{ backgroundColor: "#f2f2f2" }}>{formatDate(orderDetails?.created_at)}</h6>
                                </div>
                                <div style={{ width: "25%" }}>
                                    <p>Due Date</p>
                            ...
                            <div className='d-flex gap-1'>
                                <div style={{ width: "40%" }}>
                                    <p>Payment Method</p>
                                    <h6 className='p-1 w-100' style={{ backgroundColor: "#f2f2f2" }}>{orderDetails?.payment_method}</h6>
                                </div>
                                <div style={{ width: "100%" }}>
                                    <p>IBAN</p>
